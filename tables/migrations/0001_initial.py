# Generated by Django 2.1.2 on 2019-02-16 03:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_document', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tables.Document')),
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='child', to='tables.DocumentSection')),
            ],
            options={
                'abstract': False,
            },
